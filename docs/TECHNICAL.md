...
Build details, configuration reference, performance measurements, and development checks for Awqat. For the everyday introduction, see the [README](../README.md).
